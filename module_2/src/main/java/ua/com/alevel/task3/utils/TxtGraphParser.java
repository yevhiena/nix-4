...
public class TxtGraphParser {
    ...
    private static void parseTxt(String path) throws IOException {
    ...
    public static void getWeightedGraph(WeightedGraph weightedGraph, String path) throws IOException {
        parseTxt(path);
